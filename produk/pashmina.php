                  ...
                  <tbody>
                    <?php
                      ...
                      <tr class="text-xs font-weight-bold">
                          ...
                          <td><img src="../assets/foto_produk/<?=$data_produk['gambar']?>" width="100px";></td>
                          <td class="text-xs font-weight-bold">
                          <a class="btn btn-success" href="edit.php?nama_produk=<?=$data_produk['nama_produk']?>" >Ubah</a>

                          <a href="delete.php?nama_produk=<?=$data_produk['nama_produk']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                      </tr>
                      <?php
                      }
                      ?>
